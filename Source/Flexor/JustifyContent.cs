...
namespace Flexor
{
    ...
    public static class JustifyContent
    {
        ...
        /// </summary>
        public static IJustifyContent Start => new FluentJustifyContent().Is(JustifyContentOption.Start).OnAll();

        /// <summary>
        /// Content is centered along the midpoint of the flex-line's main axis.
        /// Content is rendered this way consistently across all CSS media query breakpoints.
        /// </summary>
        public static IJustifyContent Center => new FluentJustifyContent().Is(JustifyContentOption.Center).OnAll();

        /// <summary>
        /// Content is aligned along the end line of the flex-line's main axis.
        /// Content is rendered this way consistently across all CSS media query breakpoints.
        /// </summary>
        public static IJustifyContent End => new FluentJustifyContent().Is(JustifyContentOption.End).OnAll();
        ...
        /// </summary>
        public static IJustifyContent SpaceAround => new FluentJustifyContent().Is(JustifyContentOption.SpaceAround).OnAll();
        ...
        /// </summary>
        public static IJustifyContent SpaceBetween => new FluentJustifyContent().Is(JustifyContentOption.SpaceBetween).OnAll();
